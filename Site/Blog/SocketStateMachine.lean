...
#doc (Post) "Zero-Cost POSIX Compliance: Encoding the Socket State Machine in Lean 4's Type System" =>
...
![Socket state machine](static/blog/socket-state-machine/socket-state-machine.svg)
